...
export default function FeaturesSectionDemo() {
  const features = [
    {
      ...
      description:
        "Create stunning dashboards with our intuitive drag-and-drop interface, making data visualization a breeze.",
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto" style={{ fontFamily: 'Poppins, sans-serif' }} id="features">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          EraCrux helps you clean, organize, and visualize data with interactive dashboards and charts for clear insights.
        </p>
      </div>
